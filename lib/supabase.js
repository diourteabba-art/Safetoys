...
async function submitToy(fields) {
    ...
    .select(`
      *,
      product_substances (
        concentration, unite, niveau_confiance, methode_acquisition,
        date_mise_a_jour,
        substances ( nom, famille, cas_number, ec_number, classification_clp, description ),
        sources ( nom, type, url, fiabilite )
      )
    `)
    .eq('id', id)
